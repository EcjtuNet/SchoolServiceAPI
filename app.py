...
def get_lt_value(headers, login_url):
...
def get_ticket_url(headers, login_url, payload, encodedService, service, username, password, lt):
...
ticket_url = get_ticket_url(headers, login_url, payload, encodeService, service, username, password, lt)
login_cookie = get_login_cookie(ticket_url, headers)
info_page = get_login(login_cookie, headers, info_url)
print info_page
